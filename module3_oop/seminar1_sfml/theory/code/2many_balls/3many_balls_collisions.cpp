/*
    Данная программа рисует 10 шариков движущихся с постоянной скоростью, но если 
    какой-либо шарик  достигает границ окна, то он упруго отскакивает от границ окна.

    По сравнению с предыдущим примером, нужно просто поменять метод handleCollisions.
*/
