...
\end{verbatim}
В этой задаче вам нужно будет написать скрипт, который бы компилировал программу, подключая динамическую библиотеку к исходному файлу \texttt{main.c}.
