...
Команда \texttt{find\_file}. Алгормтм поиска файла в системе при использовании \texttt{find\_file}. Переменные:
\begin{itemize}
...
\begin{itemize}
\item \texttt{<PackageName>\_FOUND}
\item \texttt{<PackageName>\_LIBRARIES}
\end{itemize}
...
\item \texttt{GIT\_TAG}
\end{itemize}
Команда texttt{FetchContent\_MakeAvailable}.
